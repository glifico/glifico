	...
	angular.module('LanguagePairsApp').controller('LanguagePairsAppCtrl',function($http,$timeout,$scope,$mdDialog) {
		...
		ctrl.createTable=function(pairs){
			...
			for (var i = 0; i < pairs.length; i++) {
				...
				html+='<td class=" col-md-5"><button ng-click="doDelete=('+edu.IdLanguageFrom+','+edu.IdLanguageTo+')"><span aria-label="delete" class="md-secondary md-hue-3" ><i class="fa fa-trash fa-2x"></i></span></button></td>';
				html+='</tr>';
			}
			html+='</thead>';
			html+='</table>';	
